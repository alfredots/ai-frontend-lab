...
- [Índice de projetos](https://alfredots.github.io/ai-frontend-lab/)
- [Conversor de extrato / fatura](https://alfredots.github.io/ai-frontend-lab/conversor-extrato/)
- [Cursor Frontend Automation](https://alfredots.github.io/ai-frontend-lab/cursor-frontend-automation/)
- [Bugdet Sign-In (Evergreen Ledger)](https://alfredots.github.io/ai-frontend-lab/evergreen-ledger-login/)
- [STAEM Challenge (Next.js)](https://alfredots.github.io/ai-frontend-lab/staem-challenge-nextjs/)
- [UNX App (Astro)](https://alfredots.github.io/ai-frontend-lab/unx-app-astro-version/)
...
Assim, o link da pagina principal aponta para o app publicado em `https://alfredots.github.io/ai-frontend-lab/<nome-do-projeto>/` apos push na branch `main`.
